<template>
	<div class="add-update-preview">
		<el-form
			...
			label-width="180px"
			>
			<el-form-item class="add-item" label="商家号" prop="shangjiahao">
			...
			<el-form-item class="add-item" label="商家地址" prop="shangjiadizhi">
				<el-input v-model="ruleForm.shangjiadizhi" 
					placeholder="商家地址" clearable :disabled=" false  ||ro.shangjiadizhi"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="营业执照" v-if="type!='cross' || (type=='cross' && !ro.yingyezhizhao)" prop="yingyezhizhao">
				<file-upload
					tip="点击上传营业执照"
					action="file/upload"
					:limit="3"
			...
			<el-form-item class="add-item" v-else label="营业执照" prop="yingyezhizhao">
				<img v-if="ruleForm.yingyezhizhao.substring(0,4)=='http'" class="upload-img" v-bind:key="index" :src="ruleForm.yingyezhizhao.split(',')[0]">
				<img v-else class="upload-img" v-bind:key="index" v-for="(item,index) in ruleForm.yingyezhizhao.split(',')" :src="baseUrl+item">
			</el-form-item>
