<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="适合宠物" prop="shihechongwu">
				<el-input v-model="ruleForm.shihechongwu" 
					placeholder="适合宠物" clearable :disabled=" false  ||ro.shihechongwu"></el-input>
			</el-form-item>
			...
			<el-form-item class="add-item" label="使用说明" prop="shiyongshuoming">
				<el-input v-model="ruleForm.shiyongshuoming" 
					placeholder="使用说明" clearable :disabled=" false  ||ro.shiyongshuoming"></el-input>
			</el-form-item>
