	...
	<div class="addEdit-block">
		...
		>
			<template v-show="logistics">
				...
				<el-form-item class="input" v-if="type!='info'"  label="商户名称" prop="shangjiahao" >
					<el-input v-model="ruleForm.shangjiahao" placeholder="商户名称" clearable  :readonly="ro.shangjiahao"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="商户名称" prop="shangjiahao" >
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../springboot58s816sf/upload');
					} else {
