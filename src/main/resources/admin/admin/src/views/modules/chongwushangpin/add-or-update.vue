	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="适合宠物" prop="shihechongwu" >
					<el-input v-model="ruleForm.shihechongwu" placeholder="适合宠物" clearable  :readonly="ro.shihechongwu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="适合宠物" prop="shihechongwu" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="使用说明" prop="shiyongshuoming" >
					<el-input v-model="ruleForm.shiyongshuoming" placeholder="使用说明" clearable  :readonly="ro.shiyongshuoming"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="使用说明" prop="shiyongshuoming" >
					<el-input v-model="ruleForm.shiyongshuoming" placeholder="使用说明" readonly></el-input>
				</el-form-item>
				...
				<el-form-item v-else class="input" label="商家号" prop="shangjiahao" >
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.shangpinjieshao = this.ruleForm.shangpinjieshao.replace(reg,'../../../springboot58s816sf/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
